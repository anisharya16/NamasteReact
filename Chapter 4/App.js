...
//       <h4>{props.restaurant.data.area}</h4>
//     </div>
//   );
// };
...
// Smart Developers do not use props as parameter, they just pass {propName} instead of props as argument and this also works.
// const RestaurantCardSmartWay = ({ restaurant }) => {
//   return (
//     <div className="card">
//       <img
//         src={
...
// We can see that restaurant.data is being repeated several times, so to make it clean we can write the destructuring way.
...
//We can also pass props in different way
...
//         area={restaurantList[0].data.area}
//       />
//       <RestaurantCard
...
//         area={restaurantList[1].data.area}
//       />
//       <RestaurantCard
...
//         area={restaurantList[2].data.area}
//       />
//       <RestaurantCard
...
//         area={restaurantList[3].data.area}
//       />
//       <RestaurantCard
...
//         area={restaurantList[4].data.area}
//       />
//       <RestaurantCard
...
//         area={restaurantList[5].data.area}
//       />
//     </div>
//   );
// };
...
// There's another way to pass props if there are multiple of them and in the same object using spread(...) operator
// It can make our code more cleaner
const RestaurantCard = ({ name, cloudinaryImageId, cuisines, area }) => {
  return (
    <div className="card">
      <img
...
const FooterComponent = () => {
  return (
    <div className="footer">
      <h3 className="footerTitle" id="title3" key="h3">
        Food Villa
      </h3>
      <ul>
        <li>Facebook</li>
